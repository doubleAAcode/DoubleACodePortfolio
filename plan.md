...
Work-package 2B status: **In progress - the vertical master-detail Guided editor,
safe field-level draft editing, live validation, undo/redo, dirty-state
protection, and authorized admin/client saves are implemented. Step
