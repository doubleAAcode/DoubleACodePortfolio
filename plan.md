...
| 2026-07-19 | Implemented the first live Business Diagnostics slice.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Diagnostics no longer renders illustrative Atlas-style session data. It now uses the authenticated admin business details and existing secure inspect/reset actions to show real setup health, connection identity, customer session state, pinned business flow/version IDs, current node, and message trace events. Release marker is `m2c-diagnostics-session-evidence-v1`; local gates, deployment, browser acceptance, and provider media/template availability checks remain before this slice is accepted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
