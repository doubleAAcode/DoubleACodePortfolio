...
| 2026-07-19 | Advanced the Business Live Test tab from message-log-only proof toward the Milestone 2C runtime gate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | The tab now loads the business's real flow details, identifies the exact active published version under test, labels the latest draft separately, explains new-chat versus existing pinned-session behavior, and refreshes that metadata together with real provider message events. Release marker is `m2c-live-test-flow-version-v1`; local gates, deployment, browser acceptance, and real inbound runtime proof remain before this slice is accepted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
