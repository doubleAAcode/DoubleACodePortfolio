...
- [~] Route Values now has a live adapter for group-value CRUD, active state,
      ordering, delete confirmation, empty/unassigned warnings, and product
      assignment through protected admin APIs. Production browser mutation
      evidence is pending before it graduates to complete.
