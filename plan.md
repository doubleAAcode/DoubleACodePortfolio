...
- [~] Checkout Settings now reads and mutates real fulfillment policy, checkout
      ...
      protected admin adapters. Remaining proof before completion is production
      browser mutation evidence and confirming the live runtime consumes the
      saved checkout choices in a WhatsApp order flow.
