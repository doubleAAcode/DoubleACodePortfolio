...
- [~] Products now read and mutate real products, category assignment,
      ...
      values, variants, and product-specific checkout questions through the
      protected admin adapter. Custom-field deployment proof, media upload, and
      delete-blocker evidence remain before completion.
...
| 2026-07-20 | Implemented live Product custom-field controls inside the Businesses workspace.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | The Products tab now lists real product-specific checkout questions, creates/edits required labels, placeholders, types, text/number limits, and single-choice choices through `save_admin_product_custom_field`, and deletes questions through an in-page confirmation panel using `delete_admin_product_custom_field`. Release marker updated to `business-products-custom-fields-live-v1`. Local gates, deployment, authenticated production browser mutation smoke, and cleanup evidence remain before this slice is accepted. |
