      ...
      <section className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-6xl flex-col justify-center">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          <ConnectLink
            ...
            description="Build WhatsApp flows and manage the business catalog, orders, and messaging tools."
          />
          <ConnectLink
            to="/connect/admin"
            icon={ShieldCheck}
          ...
          <ConnectLink
            ...
            description="Access the secondary dashboard variant during the workspace migration."
          />
        </div>
      </section>
    </main>
...
function ConnectLink({
  ...
  to: "/connect/client" | "/connect/admin" | "/connect/dashboard-2";
