...
import { createAdminBusiness } from "@/features/connect/shared/admin-client";
import type {
  AdminBusinessStatus,
...
export const Route = createFileRoute("/connect/admin/businesses/new")({
...
function NewAdminBusinessPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      window.location.href = `/connect/admin/businesses/${created.business.id}`;
    } catch (err) {
