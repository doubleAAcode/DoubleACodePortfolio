                ...
                <div className="grid gap-3 lg:grid-cols-2">
                  ...
                  <div className="space-y-2 lg:col-span-2">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <ProductImagePreview src={productForm.image_url} name={productForm.name_english} />
                    ...
                    <div className="rounded-lg border border-border bg-background/50 p-4">
                      ...
                      <div className="mt-4 grid gap-3 lg:grid-cols-2">
                        ...
                        <TextInput
                          ...
                          onChange={(value) =>
                            setOptionForm({ ...optionForm, name_arabic: value })
                          }
                        />
                        <TextInput
                        ...
                        <SaveButton
                          ...
                          onClick={() => {
                            ...
                            const nextVariant = {
                              ...
                              sku:
                                variantForm.sku || buildVariantSku(selectedProduct.code, selectedValueRows),
                            };
      ...
      {products.map((product) => {
        ...
        return (
          ...
          >
            ...
            <button type="button" className="studio-button mt-4 w-full" onClick={() => onEdit(product)}>
              Edit product
            </button>
          </article>
        );
...
function OptionGroups({
  ...
  return (
    <div className="space-y-3">
      {groups.map((group) => (
        <section key={group.option.id} className="rounded-lg border border-border bg-background/50 p-4">
          <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
            ...
            <div className="flex gap-1">
              <button type="button" className="studio-button" onClick={() => onEditOption(group.option)}>
                Edit
              </button>
              <button
                type="button"
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {group.values.length ? (
              group.values.map((value) => (
                ...
                >
                  <button type="button" onClick={() => onEditValue(value)} className="hover:text-primary">
                    {value.value_english}
                  </button>
                  <button
                    type="button"
...
function ProductImagePreview({ src, name }: { src: string; name: string }) {
  return src ? (
    <img src={src} alt={name ? `${name} product` : ""} className="h-16 w-16 rounded-md object-cover" />
  ) : (
