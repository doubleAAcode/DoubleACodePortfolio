...
export const Route = createFileRoute("/connect/admin/businesses/$businessId/catalog-routes")({
      ...
      <header className="flex flex-wrap items-start justify-between gap-3 border-b border-border pb-4">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
            Manage route definitions only. Examples: Brands, Offers, Occasions, Collections. Route
            values and product membership are managed on their own screens.
          </p>
        </div>
  ...
  return (
    <section className="rounded-lg border border-border bg-surface/60 p-4">
      <h2 className="font-display text-lg font-semibold">
        {form.id ? "Edit route" : "Create route"}
      </h2>
