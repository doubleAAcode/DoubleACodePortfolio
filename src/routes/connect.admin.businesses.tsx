...
import type { AdminBusinessSummary } from "@/features/connect/shared/admin-store.server";
...
function AdminBusinessesPage() {
  ...
  const showingBusinessDetails = pathname.replace(/\/+$/, "") !== "/connect/admin/businesses";
              ...
              {loading ? (
                ...
                filtered.map((business) => (
                  <tr
                    ...
                    tabIndex={0}
                    onClick={() => {
                      window.location.href = `/connect/admin/businesses/${business.id}`;
                    }}
                    onKeyDown={(event) => {
                  ...
                  >
                    <td className="px-4 py-4">
                      <a
                        href={`/connect/admin/businesses/${business.id}`}
