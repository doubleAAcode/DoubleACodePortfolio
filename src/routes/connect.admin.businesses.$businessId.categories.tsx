...
import type { WaCategoryRow } from "@/features/connect/shared/dashboard-store.server";

export const Route = createFileRoute("/connect/admin/businesses/$businessId/categories")({
