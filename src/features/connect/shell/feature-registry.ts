...
export const clientFeatures: ConnectFeature[] = [
  ...
  },
  {
    id: "enterprise",
    title: "Enterprise",
    href: "/connect/client/enterprise",
    icon: ShieldCheck,
    status: "future",
    group: "Later",
    summary: "Enterprise identity, governance, and compliance controls for a later phase.",
    capabilities: ["SSO and SCIM", "Data governance", "Compliance controls"],
  },
];
